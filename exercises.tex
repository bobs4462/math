...
% trying to solve for $\lambda$ using quadratic formula:
% $$\lambda = \frac{2(x_1y_1 + x_2y_2) + \sqrt{[-2(x_1y_1 + x_2y_2)]^2 - 4(y_1^2 + y_2^2)(x_1^2 + x_2^2)}}{2(y_1^2 + y_2^2)}$$
% $$\lambda = \frac{(x_1y_1 + x_2y_2) + \sqrt{(x_1y_1 + x_2y_2)^2 - (y_1^2 + y_2^2)(x_1^2 + x_2^2)}}{(y_1^2 + y_2^2)}$$
% $$\lambda = \frac{(x_1y_1 + x_2y_2) + \sqrt{(x_1^2y_1^2 + 2x_1y_1x_2y_2 + x_2^2y_2^2) - (x_1^2y_1^2 + x_1^2y_2^2 + x_2^2y_1^2 + x_2^2y_2^2)}}{(y_1^2 + y_2^2)}$$
\end{document}
